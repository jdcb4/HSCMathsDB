...
QA now judges each candidate one by one against the original rendered page and the proposed crop, so
remaining crop QA flags are a corpus-promotion blocker rather than a manual review nicety.
