...
- 2025 Mathematics Standard: 68/68 official draft records promoted across Standard 1 and Standard 2 with marking-guide excerpts and Section II marking feedback where extractable. Standard 1 has reviewed exam-derived assets and source-reviewed overrides for the visual and notation issues identified in the 2025 audit; `pnpm run data:audit-ingested-exams -- std1-2025` reports zero issues. Standard 2 is still awaiting the same reviewed asset/notation pass.
...
- Next import work can continue with the 2025 Standard 2 review/crop pass, followed by the 2025 Extension 1 and Extension 2 review/crop passes. Keep using `pnpm run data:report-coverage -- <source-pack-id>` as the compact progress check before opening large extracted files.
