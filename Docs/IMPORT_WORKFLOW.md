...
- Next import work can continue with the 2025 Extension 1 and Extension 2 review/crop passes. Keep using `pnpm run data:report-coverage -- <source-pack-id>` as the compact progress check before opening large extracted files.
